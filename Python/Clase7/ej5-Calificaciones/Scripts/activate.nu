...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\LUNA\PythonUTN\Clase7\ej5-Calificaciones'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\LUNA\PythonUTN\Clase7\ej5-Calificaciones\Scripts\deactivate.nu'

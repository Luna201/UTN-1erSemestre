...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\LUNA\PythonUTN\Clase7\Ej3-EstacionDelAño'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\LUNA\PythonUTN\Clase7\Ej3-EstacionDelAño\Scripts\deactivate.nu'

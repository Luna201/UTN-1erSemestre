...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\LUNA\PythonUTN\Clase7\Ej4-EtapaDeVida'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\LUNA\PythonUTN\Clase7\Ej4-EtapaDeVida\Scripts\deactivate.nu'
